...
#------------------------------------------------------------------------------------------------------------------
# KNN Classifier for H1N1  ------------------------------------------------------------------------------
#------------------------------------------------------------------------------------------------------------------

kn_model = KNeighborsClassifier()
gb_model = GradientBoostingClassifier(random_state=42)
rf_model = RandomForestClassifier(random_state=42, class_weight={0: 0.55, 1: 0.45})
voting_clf = VotingClassifier(estimators=[('kn', kn_model), ('gb', gb_model), ('rf', rf_model)], voting='soft')
...
output_path = "predicciones_intento_gradient.csv"
