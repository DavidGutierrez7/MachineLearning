...
grid = GridSearchCV(estimator=cat_model, param_grid=param_grid, cv=CV_h1_n1, n_jobs=-1, scoring='roc_auc')
...
grid = GridSearchCV(estimator=cat_model, param_grid=param_grid, cv=CV_seasonal, n_jobs=-1, scoring='roc_auc')
